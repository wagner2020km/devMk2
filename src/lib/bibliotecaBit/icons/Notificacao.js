		...
		>
			<g id="Camada_1-2" transform="translate(0.004 0)">
				...
				<rect
					...
					width="7.456"
					height="1.1"
					transform="translate(3.284 3.207)"
					fill={props.color ? props.color : '#FFF'}
				/>
				<rect
					id="Retângulo_94"
					...
					width="7.456"
					height="1.1"
					transform="translate(3.284 4.918)"
					fill={props.color ? props.color : '#FFF'}
				/>
				<rect
					id="Retângulo_95"
					...
					width="7.456"
					height="1.1"
					transform="translate(3.284 6.873)"
					fill={props.color ? props.color : '#FFF'}
				/>
			</g>
		</svg>
